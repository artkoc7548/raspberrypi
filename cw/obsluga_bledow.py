'''
Pamiętasz przykład, w którym przetwarzaliśmy dane o zamówieniach z aptek?
Jeśli nie, to zajrzyj do laboratorium sprzed dwóch lekcji :)

Wczytywaliśmy tam dane z pliku, a potem przetwarzaliśmy linijka po linicje. Każda z linijek zawierała informacje o nazwie apteki, nazwie leku i ilości zamawianego leku.

Już w poprzednim rozwiązaniu zadania spodziewaliśmy się pewnych problemów i zabezpieczaliśmy się przed nimi. Gdyby z apteki przyszło  zamówienie, które nie miało dokładnie 3 póli, to nie przetwarzaliśmy go, ale:
...
może się zdarzyć, ze w linijce zabraknie jakiś kolumny
...
Zauważ błedy: linijka 2 - dodatkowa kolumna, linijka 5 - znak zapytania w kolumnie z ilością, linijka 7 - za mało kolumn
...
w przypadku błędu wyświetli linijkę, w której doszło do błędów oraz infromacje na temat samego błedu
